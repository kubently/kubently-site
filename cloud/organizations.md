...
subtitle: Teams, membership, and access control in Kubently Cloud.
permalink: /cloud/organizations/
---

{% include cloud-badge.html %} Organizations are how teams share a Kubently
Cloud tenant: one org owns the connected clusters, the incident history, the
Slack app installation, and the plan.
...
assignment, cluster ownership) is being written. Meanwhile, the in-app
settings at <a href="https://cloud.kubently.io">cloud.kubently.io</a> cover
the common cases, and <a href="mailto:hello@kubently.io">hello@kubently.io</a>
answers the rest.
</div>
